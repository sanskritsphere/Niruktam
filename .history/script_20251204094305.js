...
function renderSutra(index) {
  ...
  container.innerHTML = `
    <div class="sutra">
      ...
      <div class="section">
        <button class="toggle-btn" onclick="toggleExclusive('skand')">श्रीस्कन्दस्वामिमहेश्वरविरचिता निरुक्तभाष्यटीका</button>
        <div id="skand" class="toggle-content"><hr>${highlightDoubts(sutra.skand, doubtTexts)}</div>
      </div>
       <div class="section">
        <button class="toggle-btn" onclick="toggleExclusive('skand')">THE NIRUKTA</button>
        <div id="skand" class="toggle-content"><hr>${highlightDoubts(sutra.skand, doubtTexts)}</div>
      </div>
