...
const customVyakhya = [
  ...
  {
    "shabda": "निघण्टवः कस्मात्",
    "vyakhya": "निघण्टु शब्द की उत्पत्ति के कारण की जिज्ञासा।"
  },
  {
...
function renderSutra(index) {
  ...
  `;
    ...
    if (hasCustom) {
      ...
      // custom व्याख्या नहीं → clickable नहीं बनाओ
      anchor.style.cursor = 'default';
      anchor.title = '';
      anchor.onclick = null;
    }
